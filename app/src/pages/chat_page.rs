...
pub fn ChatPage() -> impl IntoView {
    ...
    let (dynamic_elements, set_dynamic_elements) = leptos_signal(HashMap::<usize, Vec<DynamicElementData>>::new());
                        ...
                        children=move |msg| {
                            ...
                            let msg_styles = move || {
                                let base_styles = if msg.is_user {
                                    "padding: 12px 16px; border-radius: 18px; border-bottom-right-radius: 4px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); max-width: 85%; text-align: left; background-color: #dbeafe; color: #1e40af;"
                                } else {
